...
def _format_diary_entry(d: DiaryEntry) -> dict[str, Any]:
    ...
    return {
        ...
        "riskWarning": {
            ...
            "level": "Tinggi (68%)",
            "message": "LUNA mendeteksi akumulasi kecemasan dan stres pada 3 sesi percakapan hari ini. Jangan ragu mengambil waktu jeda istirahat.",
        } if "Cemas" in (d.mood_tag or "") else None,
