...
class _SplashOnboardingScreenState extends State<SplashOnboardingScreen> {
  ...
  /// Minimalist native-like splash screen displaying the centered app icon and branding.
  Widget _buildMinimalistSplash() {
    return Center(
      key: const ValueKey('minimalist_splash'),
      child: Column(
  ...
  /// Onboarding content card shown after session verification when user is unauthenticated.
