...
import '../core/routes/app_route_transitions.dart';
...
class SupportEmergencyScreen extends StatefulWidget {
  ...
  static Route<void> route() {
    return AppRouteTransitions.modalSlideUpRoute<void>(
            ...
            child: Padding(
              ...
              child: Column(
                    children: [
                      ...
                      // Heart Badge Visual with Breathing Pulse Animation & Tap action                      // Animated Soft Emergency / Pulse Indicator
                      StaggeredEntrance(
                        index: 0,
                        child: Column(
                          children: [
