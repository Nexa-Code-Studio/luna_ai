                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildVoiceChoiceTile(
                                    title: 'Luna - Lembut & Tenang',
                                    subtitle: 'Artikulasi santai untuk meredakan kecemasan',
                                    icon: Icons.spa_rounded,
                                    isSelected: _selectedVoice == 'Luna - Lembut & Tenang',
                                    onTap: () {
                                      setState(() => _selectedVoice = 'Luna - Lembut & Tenang');
                                      _saveSetting('settings_voice', 'Luna - Lembut & Tenang');
                                    },
                                  ),
                                  const SizedBox(height: 8),
                                  _buildVoiceChoiceTile(
                                    title: 'Luna - Ramah & Hangat',
                                    subtitle: 'Nada bersahabat dan penuh afeksi positif',
                                    icon: Icons.favorite_rounded,
                                    isSelected: _selectedVoice == 'Luna - Ramah & Hangat',
                                    onTap: () {
                                      setState(() => _selectedVoice = 'Luna - Ramah & Hangat');
                                      _saveSetting('settings_voice', 'Luna - Ramah & Hangat');
                                    },
                                  ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          '${_speechRate.toStringAsFixed(2)}x (${_speechRate == 1.0 ? "Normal" : _speechRate < 1.0 ? "Tenang" : "Cepat"})',
                                          style: GoogleFonts.inter(
                                            fontSize: 10,
                                            fontWeight: FontWeight.w700,
